...
class TestHBNBCommand_prompting(unittest.TestCase):
    """HBNB Command Interpreter Claim Test Unit."""
...
class TestHBNBCommand_help(unittest.TestCase):
    """Unit test HBNB command interpreter help messages."""
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Unit to test out the HBNB command interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Test modules for testing generated from the HBNB command interpreter."""
...
class TestHBNBCommand_show(unittest.TestCase):
    """Test display unit of HBNB command interpreter"""

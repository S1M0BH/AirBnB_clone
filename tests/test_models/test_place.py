#!/usr/bin/python3
"""Defines unit for models/place.py."""
import os
import models
import unittest
...
class TestPlace_instantiation(unittest.TestCase):
    """Unit test creation of a place class."""
...
class TestPlace_save(unittest.TestCase):
    """Unit-testing method save from the location class."""
...
class TestPlace_to_dict(unittest.TestCase):
    """A module to test the to_dict method for a location row."""

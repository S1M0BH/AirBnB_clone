#!/usr/bin/python3
"""Defines unit for models/review.py."""
import os
import models
import unittest
...
class TestReview_instantiation(unittest.TestCase):
    """Unit to test instantiation of revision class."""
...
class TestReview_save(unittest.TestCase):
    """Memorization method unit test for revision class."""
...
class TestReview_to_dict(unittest.TestCase):
    """A unit to test the to_dict method of the revision class."""

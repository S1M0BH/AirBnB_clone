...
class HBNBCommand(cmd.Cmd):
    """The compiler commanded the row"""
    prompt = '(hbnb) '
    ...
    def parse(arg):
        """The middleware parses the input and returns a list of parsed element"""
    ...
    def do_quit(self, arg):
        """Quit cmd to exit programme"""
        return True

    def do_EOF(self, arg):
        """Exit programme with EOF"""
        print("")
        return True
    ...
    def do_create(self, arg):
        """Create a new instance of the base form"""
        if len(arg) == 0:
    ...
    def do_show(self, arg):
        """Print a str representation of an instance"""
    ...
    def default(self, line):
        """cmd default behavior when input is not valid"""
        self._precmd(line)
...
Usage: count <class_name>, or <class_name>.count()"""
    ...
    def _precmd(self, line):
        """Test intercept commands for class.syntax()"""
